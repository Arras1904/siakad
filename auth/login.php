...
<body>
    <div class="login-card">
        <!-- Logo -->
        <img src="<?= BASE_URL ?>assets/images/Logo Unindra.png" alt="Logo UNINDRA" class="login-logo">
        <!-- Judul -->
        ...
        <?php if (isset($_SESSION['error'])): ?>
            <div class="bg-red-500 text-white p-3 rounded mb-4 text-center text-sm">
        ...
        <form action="proses_login.php" method="POST" class="login-form">
            ...
            <div class="input-group">
                ...
                <input type="text" name="username" class="input-box" placeholder="Masukkan Username" autocomplete="off" required>
            </div>
            <!-- Password -->
            <div class="input-group">
                <label>Password</label>
                <div style="position:relative;">
                    <input type="password" id="password" name="password" class="input-box" placeholder="Masukkan Password" required>
                    <button type="button" onclick="togglePassword('password','iconPassword')">
                        <i id="iconPassword" class="fa-solid fa-eye"></i>
                    </button>
                </div>
            </div>
            <!-- Remember -->
